...
Before plotting, the mean % methylation of sites in gene $j$ in methylome $i$ has been mean-centered and scaled. Thus, orange indicates that the gene $j$ makes up an above-average fraction of transcriptome $i$, and purple indicates a below-average fraction.
