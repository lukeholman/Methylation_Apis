...
meth_sample_heatmap <- function(mean_cutoff, colour_limits){
  ...
  foc = invisible(t(ComBat(dat = t(foc), 
                         batch = batch, 
                         mod = mod, 
                         par.prior = TRUE)))
...
###### Figure
```{r fig.width=6.9, fig.height = 11.5}
GO_KEGG_results$GO_Dmel_annotations_caste %>%
...
###### Figure
```{r fig.width=6.9, fig.height = 10.4}
GO_KEGG_results$GO_Amel_annotations_caste %>%
  filter(Test_type == "GO: Molecular function") %>%
  make_pathway_figure("", "Hours post-grafting")
```
...
###### Figure
```{r fig.width=6.9, fig.height = 5.5}
GO_KEGG_results$GO_Dmel_annotations_caste %>%
