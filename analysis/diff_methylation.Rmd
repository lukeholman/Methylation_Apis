...
redo <- FALSE
if(length(list.files("figures/bayes_sites/")) < length(plot_sites_split) | redo){
  for(i in 1:length(plot_sites_split)){
    ggsave(glue("figures/bayes_sites/plot{i}.png"), 
           do.call("grid.arrange", lapply(plot_sites_split[[i]], plot_one_site)),
           height = 9, width = 9)
  }
}
```
...
<!-- if(redo) saveRDS(do.call("grid.arrange", lapply(plot_sites[237:251], plot_one_site)), "figures/bayes_sites/plot16.rds") -->
<!-- readRDS("figures/bayes_sites/plot16.rds") -->
<!-- ``` -->
