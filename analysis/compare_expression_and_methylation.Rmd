...
pdf("figures/composite_GO.pdf", width = 10.8, height =  10.4, onefile = FALSE)
...
```{r big_cor_plot, fig.height = 9, fig.width = 12, warning=FALSE, warning=FALSE}
corrs <- merged_data %>%
...
```{r echo = FALSE, warning=FALSE, warning=FALSE, results='hide', fig.showtext=TRUE}
