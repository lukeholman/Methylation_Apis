...
In the following table, a **positive** log fold change in expression indicates **higher expression at later times** than earlier times for a given type of larva (QDL or WDL). You can also view this table on a full web page [here](queen_time_table.html), or press the buttons to export the table.
