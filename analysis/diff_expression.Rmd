...
In the following table, a **positive** log fold change in expression indicates **higher expression in QDL** relative to WDL measured at the same time point. One can also view this table on a full web page [here](caste_table.html), or press the buttons to export the table.
...
### Enrichment results for genes showing _caste differences_ in expression
...
### Enrichment results for genes showing _temporal changes_ in expression
