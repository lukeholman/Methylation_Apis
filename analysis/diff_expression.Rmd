...
Here, the expression level of gene $j$ in transcriptome $i$ has been converted to a proportion of the total, then mean-centered and scaled. Thus, red indicates that the gene $j$ makes up an above-average fraciton of transcriptome $i$, and blue indicates a below-average fraction.
