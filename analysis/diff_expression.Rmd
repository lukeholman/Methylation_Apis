...
mean_line_data <- bind_rows(
  preds[is.na(mean_line_data$Caste), ] %>% mutate(Caste = "Queen"),
  preds[is.na(mean_line_data$Caste), ] %>% mutate(Caste = "Worker"),
  preds[!is.na(mean_line_data$Caste), ])
